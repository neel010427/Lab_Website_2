...
function loadStatsPage(){
	...
	{
			oppName = table.rows[rCounter].cells[1].innerHTML;
			home = parseInt(table.rows[rCounter].cells[2].innerHTML);
			opp = parseInt(table.rows[rCounter].cells[3].innerHTML);
			if(home > opp)
			{
				homeScore++;
				document.getElementById("wins").innerHTML = homeScore;
				table.rows[rCounter].cells[4].innerHTML = "CU Boulder";
			}
			else
			{
				oppScore++;
				document.getElementById("losses").innerHTML = oppScore;
				table.rows[rCounter].cells[4].innerHTML = oppName;
			}
	}
}
/*
...
function loadPlayersPage(){
	...
	{
		text += '<a href = "#" class="dropdown-item" onclick = "switchPlayers(' + i + ')" > '+ players[i].name +'</a>';
	}
...
function switchPlayers(playerNum){
	...
	var avgPYards = (pYards/games).toFixed();
	var avgRYards = (rYards/games).toFixed();
	var avgRecYards = (recYards/games).toFixed();
